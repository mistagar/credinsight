        ...
        >
            ...
            >                <div className='flex items-center'>
                    ...
                    <motion.button
                        ...
                        className='flex items-center px-4 py-2 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white rounded-md font-medium shadow-lg hover:shadow-xl transition-all duration-200'
                    >
            ...
            <AnimatePresence mode='wait'>
                ...
                >                        {/* Customer Information Card */}{' '}
                    <motion.div
                        className='relative overflow-hidden rounded-lg border border-gray-200 bg-white shadow-xl dark:bg-zinc-900/70 dark:border-zinc-700 md:col-span-1'
                        whileHover={{
                            y: -5,
                    ...
                    </motion.div>                        {/* Risk Assessment Card */}
                    <motion.div
                        className='relative overflow-hidden rounded-lg border border-gray-200 bg-white shadow-xl dark:bg-zinc-900/70 dark:border-zinc-700 md:col-span-2'
                        whileHover={{
                            y: -5,
